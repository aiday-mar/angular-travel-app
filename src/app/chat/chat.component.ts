...
@Component({
    ...
    template: `
        ...
        <div style="position: absolute; right:0;cursor: pointer;border:1px solid grey; padding-left:5px; padding-right:5px;border-radius:5px; background-color:white;" (click)="showHideChat()" *ngIf='showChat'> X </div> <br/>
        <kendo-chat
            [messages]="messages"
            [user]="user"
